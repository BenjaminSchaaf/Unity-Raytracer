...
public class RayTracer_github : MonoBehaviour {
...
*/
    ...
    */
    ...
    private bool SingleMaterialOnly = false;
    ...
    private float tmpFloat2;

    private Texture2D tmpTex;
    private Material tmpMat;

    private MeshFilter tmpMeshFilter;
    ...
    //Collision Mask
    public global::System.Object CollisionMask { get => collisionMask; set => CollisionMask = 1 << 31; }
    private var LayerMask = CollisionMask;
